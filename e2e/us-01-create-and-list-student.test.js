...
describe("US-01 - Create and list students - E2E", () => {
    let page;
    let browser;
    ...
    describe("/students/new page", () => {
        test("filling and submitting form creates a new student and then displays the dashboard for the student date", async() => {
            ...
            await page.type("input[name=student_date]", "01012035");
            await page.type("input[name=student_time]", "1330");
